...
#include <Wire.h>
//---------------FONT + GRAPHIC-----------------------------//
#include </Users/sak/Documents/Arduino/i2c_OLED/data.c>
//==========================================================//
...
unsigned char fill_string1[]="Atlantaman";
unsigned char fill_string2[]="OLED 128*64";
unsigned char fill_string3[]="0123456789A";
unsigned char fill_string4[]="ArduinoMEGA";
...
{
  setXY(y,0);
  for(int i=0;i<128;i++)     // show 128* 64 picture
  {
    SendChar(logo[i+y*128]);
  }
}

//  sendcommand(0x21);
//  sendcommand(0);                          //command mode
//  sendcommand(127);
//  sendcommand(0x22);
//  sendcommand(0);                          //command mode
//  sendcommand(7);
...
//==========================================================//
void setXY(unsigned int row,unsigned int col)
{
  sendcommand(0xb0+row);                //set page address
  sendcommand(0x10+((col>>4)&0x0f));  //set high col address
  sendcommand(0x00+(col&0x0f));       //set low col address
}
...
void init_OLED(void)
{
  ...
  sendcommand(0x8f);//--set contrast level
